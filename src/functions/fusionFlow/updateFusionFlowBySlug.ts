...
export const RequsetUpdateFusionFlowBody = {
  title: "RequsetUpdateFusionFlowBody",
  RequsetUpdateFusionFlowBody: eventSchema.properties.body,
};
...
> = async (event) => {
  ...
  try {
    ...
    Item.id = `${accountId}:fusion_flows_history`;
