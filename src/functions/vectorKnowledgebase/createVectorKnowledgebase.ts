...
export const RequsetCreateVectorKnowledgebaseBody = {
  title: "RequsetCreateVectorKnowledgebaseBody",
  RequsetCreateVectorKnowledgebaseBody: eventSchema.properties.body,
};
