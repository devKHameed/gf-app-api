...
export const RequsetUpdateVectorKnowledgebaseBody = {
  title: "RequsetUpdateVectorKnowledgebaseBody",
  RequsetUpdateVectorKnowledgebaseBody: eventSchema.properties.body,
};
