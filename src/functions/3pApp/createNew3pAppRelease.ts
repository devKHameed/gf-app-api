...
> = async (event) => {
  try {
    ...
    three_p_app.three_p_version = old_three_p_app.three_p_version + 0.01;
    ...
    const updateParams: DynamoDB.DocumentClient.UpdateItemInput =
      buildUpdateExpression({
        ...
        tableName: TABLE_NAME,
        item: { three_p_version: old_three_p_app.three_p_version + 0.1 },
      });
    ...
    return {
      statusCode: 200,
      body: { message: "Release added", data: three_p_app },
    };
  } catch (error: unknown) {
